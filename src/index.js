...
// "news.ycombinator.com" → "ycombinator"; sanitised to Stalwart's allowed chars
function getBaseLabel(domain) {
...
async function createAlias(domain, stalwartToken, description = null) {
  ...
  return { email: result.email, description: cleanDescription };
}
